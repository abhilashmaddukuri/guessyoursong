...
public class MemoryInsaneAfterNextActivity extends Activity
	{
		...
		public void onCreate(Bundle savedInstanceState)
			{
				...
				int minsane_score_songs_inbank = 0;
				long mhigh_after_next = 0;
				
				Bundle extras = getIntent().getExtras();
				if (extras != null) {
					minsane_score_songs_inbank= extras.getInt("minsane_score_songs_inbank");
					mhigh_after_next= extras.getLong("mhigh");
				}
				
				
				TextView mnormal_score_songs_inbank = (TextView)findViewById(R.id.songs_inbank_memory);
				mnormal_score_songs_inbank.setText(""+minsane_score_songs_inbank);
			    ...
			    replay.setOnClickListener(new View.OnClickListener() {
			        ...
			        public void onClick(View v) {
	            	    ...
	            	    mp.start();
			        	final ProgressDialog ringProgressDialog = ProgressDialog.show(MemoryInsaneAfterNextActivity.this, "",	"Getting songs...", true);
