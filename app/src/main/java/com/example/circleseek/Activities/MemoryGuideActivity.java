...
public class MemoryGuideActivity extends Activity
	{
		...
		public void onCreate(Bundle savedInstanceState)
			{
		        ...
		        String desc ="<br/>-Enrich your memory in guessing songs from your own playlists.<br/>-Easy, Hard and Insane levels varies with time and number of songs.";
