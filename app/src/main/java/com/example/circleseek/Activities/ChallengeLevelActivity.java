...
public class ChallengeLevelActivity extends Activity
	{
	...
	private ProgressBar spinner;
		...
		public void onCreate(Bundle savedInstanceState)
			{
				...
				setContentView(R.layout.challenge_level_layout);
		...
		// End of advertisements ki code here....	
				...
				//TranslateAnimation moveLefttoRight = new TranslateAnimation(0, 100, 0, 0);
			...
			//	memory_button.setOnClickListener(this);
				...
				ImageButton challenge_normal = (ImageButton) this.findViewById(R.id.challenge_normal);
			//	ChallengeNormalActivity.startAnimation(animAnticipateOvershoot_one);
				//ChallengeNormalActivity.startAnimation(moveLefttoRight);
				//challenge_button.setOnClickListener(this);
				ImageButton challenge_hard = (ImageButton) this.findViewById(R.id.challenge_hard);
			//	ChallengeHardActivity.startAnimation(animAnticipateOvershoot_two);
				//ChallengeHardActivity.startAnimation(moveLefttoRight);
				ImageButton challenge_insane = (ImageButton) this.findViewById(R.id.challenge_insane);
			//	ChallengeInsaneActivity.startAnimation(animAnticipateOvershoot_three);
				//ChallengeInsaneActivity.startAnimation(moveLefttoRight);
				
				TextView challenge_normal_text= ((TextView) findViewById(R.id.challenge_normal_text));
				challenge_normal_text.setTypeface(tf_bold);
				
				TextView challenge_hard_text= ((TextView) findViewById(R.id.challenge_hard_text));
				challenge_hard_text.setTypeface(tf_bold);
				
				TextView challenge_insane_text= ((TextView) findViewById(R.id.challenge_insane_text));
				...
				//heading.startAnimation(anim_top_in);
				
	//			TextView description= ((TextView) findViewById(R.id.description));
	//			description.setText(Html.fromHtml(desc));
	//			description.startAnimation(animAnticipateOvershoot_one);
				
				RelativeLayout relative_normal =(RelativeLayout)findViewById(R.id.relative_one);
				//relative_normal.startAnimation(animAnticipateOvershoot_one);
		         relative_normal.setOnClickListener(new View.OnClickListener(){
		             ...
		             public void onClick(View v){
		            	 MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.onclick);
		            	    mp.start();
		            	 final ProgressDialog ringProgressDialog = ProgressDialog.show(ChallengeLevelActivity.this, "",	"Getting songs...", true);
		         ...
		         //relative_hard.startAnimation(animAnticipateOvershoot_one);
		         ...
		         //relative_insane.startAnimation(animAnticipateOvershoot_one);
