...
public class ChallengeGuideActivity extends Activity
	{
		...
		public void onCreate(Bundle savedInstanceState)
			{
		        ...
		        String desc ="<br/>-A random clip of a song from your playlist is played, while you guess the song by choosing the options given.<br/>-Easy, Hard and Insane levels varies with time.<br/>-You can score points on the basis of your speed and accuracy, while you can also compete with your friends.";
