...
package com.example.circleseek.Views;
...
public class CircularProgressBar extends ProgressBar{
	...
	public static int mreduceDimen;
	
	public long progress_duration;
	...
	public void init(AttributeSet attrs, int style){
		...
		mStrokeWidth = a.getInt(R.styleable.CircularProgressBar_strokeWidth, STROKE_WIDTH)+10;
		
	//	mreduceDimen = a.getInt(R.styleable.CircularProgressBar_strokeWidth, reduceDimen)+20;
		...
		//int parentWidth = MeasureSpec.getSize(widthMeasureSpec);
		 //  int parentHeight = MeasureSpec.getSize(heightMeasureSpec);
		  // int parentWidth = getMeasuredWidth();
		   ...
		   //final int height = parentHeight;
		   //final int width = parentWidth;
		final int height = getSuggestedMinimumHeight()*3;
		//final int height = getDefaultSize(getSuggestedMinimumHeight(), heightMeasureSpec) - 200;
	//final int height = 50;
		//final int width = 50;
		//final int width = getDefaultSize(getSuggestedMinimumWidth(), widthMeasureSpec) - 200;
		final int width = getSuggestedMinimumWidth()*3;
	...
	public void progress_duration(long i) {
		progress_duration = i;
